        ...
        <div className="bg-yellow-50 dark:bg-gray-900 py-20 px-4 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center md:items-center gap-1">
                ...
                <div className="w-full md:w-2/3 flex justify-center">
                    <div className="w-36 sm:w-40 md:w-48 aspect-[9/20] rounded-xl relative">
                        <Image
                            src="/interview.png"
                            alt="리뷰화면"
                            fill
                            className="mx-5 object-cover rounded-lg"
                        />
                    </div>
                </div>

                {/* 오른쪽 텍스트 영역 */}
                <div className="w-full md:w-5/7 -mx-8 flex flex-col justify-center text-left md:pl-0">
                    ...
                    <h2 className="text-lg sm:text-xl font-extrabold text-gray-900 dark:text-white mb-4">

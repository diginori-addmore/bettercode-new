  ...
  const contentData = [
    {
      ...
      업그레이드를 받을 수 있습니다. \n \
      월간/연간 구독형 서비스로, 초기 비용부담은 줄이고\n \
      지속적으로 개선된 서비스를 이용할 수 있습니다.",
    ...
    },
    {
      ...
      한국에 있는 계좌로 판매대금을 \n \
      직접 받을 수 있습니다",
      description: "한국 사업자 등록증으로 미니프로그램을 직접 개설 및\n \
      운영이 가능합니다.\n \
    ...
    },
    {
      ...
      description: "2016년부터 북경에 수년간 커머스 시스템을 개발,\n \
      운영한 경험이 있는 한국 개발자가 서비스를\n \
      개발/운영하고 있습니다.\n \
      한국 개발팀이 자체 개발한 위챗 미니프로그램과\n \
      웹 관리도구를 제공합니다.\n \
